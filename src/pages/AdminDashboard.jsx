...
const AdminDashboard = () => {
    ...
    return (
        <div className="p-6 md:p-10 max-w-[1280px] mx-auto flex flex-col gap-10">
            ...
            {/* Analytics Section */}
            <div className="bg-[#16212b] rounded-3xl border border-[#223649] overflow-hidden shadow-xl p-6">
                <div className="mb-4">
                    <h3 className="font-bold">การวิเคราะห์ข้อมูล (Analytics)</h3>
                    <p className="text-sm text-slate-400">ข้อมูลเชิงลึกจาก Notebook Analysis</p>
                </div>
                <KaggleEmbed />
            </div>

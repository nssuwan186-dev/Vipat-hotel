...
const HotelReviews = () => {
  ...
  return (
    <div className="p-6 max-w-[800px] mx-auto text-white">
      <h1 className="text-2xl font-black mb-6">รีวิวจากผู้เข้าพัก</h1>
      <div className="flex flex-col gap-4">
        {reviews.map((r, i) => (
            <div key={i} className="bg-[#16212b] p-5 rounded-3xl border border-[#223649]">
                ...
                <p className="text-[10px] text-slate-600 mt-2">{r.date}</p>
            </div>
        ))}

      ...
      <main className="flex-1 py-8 px-4 sm:px-6">
        <div className="mx-auto max-w-4xl flex flex-col gap-6">
          <div className="flex flex-col gap-2">
            <h1 className="text-3xl font-black tracking-tight text-slate-900 dark:text-white">My Bookings</h1>
            <p className="text-base text-slate-500 dark:text-text-secondary">Manage and view your upcoming stays and history.</p>
          </div>
          ...
          <div className="border-b border-slate-200 dark:border-border-dark">
            <nav className="-mb-px flex space-x-8">
              <a href="#" className="border-primary text-primary border-b-2 py-4 px-1 text-sm font-bold flex items-center gap-2">
                <span className="material-symbols-outlined text-[20px]">event_upcoming</span> Upcoming
              </a>
                ...
                <div className="flex flex-1 flex-col justify-between p-5">
                  <div className="flex flex-col gap-1">
                    <div className="flex justify-between items-start mb-1">
                      <p className="text-xs font-medium text-slate-500 dark:text-text-secondary tracking-wide uppercase">Booking #{booking.id}</p>
                  ...
                  <div className="mt-6 flex items-center justify-between border-t border-slate-100 dark:border-border-dark pt-4">
                    <div className="flex flex-col">
                      <span className="text-xs text-slate-500 dark:text-text-secondary">Total Price</span>
                      <span className="text-lg font-bold text-primary">฿{booking.price.toLocaleString()}</span>
                    </div>
                    <div className="flex gap-3">
                       <button className="text-sm font-medium text-slate-500 dark:text-gray-400 hover:text-red-500 px-3 py-2 transition-colors">Cancel</button>

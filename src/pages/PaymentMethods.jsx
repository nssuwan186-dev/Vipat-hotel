  ...
  return (
    <div className="p-6 max-w-md mx-auto text-white">
      ...
      <div className="flex flex-col gap-4">
        <div className="bg-[#16212b] p-5 rounded-3xl border border-[#223649] flex items-center gap-4">
        ...
        <button className="border-2 border-dashed border-[#223649] p-4 rounded-3xl text-slate-500 font-bold text-sm flex items-center justify-center gap-2">
